...
- 😊 I'm quite proud of the [two functions i wrote](https://github.com/Cynog/arduino-extram/blob/main/lib_extram.hpp) for the Arduino Uno to read and write from/to an external RAM found in my [arduino-extram](https://github.com/Cynog/arduino-extram/) repository
